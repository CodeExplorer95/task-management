...
type Props = NativeStackScreenProps<ScreenParamList, Screens.Signup>;
...
const Signup = ({ navigation }: Props) => {
  ...
  const onSignupClick = async () => {
    ...
    const response = await profileController.signupwithEmailandpassword();
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <BlankSpace
              width={figmaW(153)}
              height={figmaH(1)}
              backgroundColor={colors[ColorName.secondary_097]}
            />
            <Text
              style={{
                fontSize: figmaW(14),
